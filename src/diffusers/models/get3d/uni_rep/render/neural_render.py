...
from diffusers.models.get3d.uni_rep.render import Renderer
...
class NeuralRender(Renderer):
    ...
    def render_mesh(
        ...
        print("====v_pos in ===", mesh_v_pos_bxnx3.shape)
        print("====camera_mv===", camera_mv_bx4x4.shape)
        v_pos = xfm_points(mesh_v_pos_bxnx3, mtx_in)  # Rotate it to camera coordinates
        print("====v_pos ===", v_pos.shape)

...
from .scheduling_ddpm import betas_for_alpha_bar_shap_e
...
class DPMSolverMultistepScheduler(SchedulerMixin, ConfigMixin):
    ...
    def set_timesteps(self, num_inference_steps: int = None, device: Union[str, torch.device] = None, sync_timesteps=None):
        """
        ...
        self.timesteps = torch.from_numpy(timesteps).to(device) if sync_timesteps is None else sync_timesteps # NOTE(lihe): timestep syncronize

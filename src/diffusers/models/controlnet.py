...
class ControlNetModel(ModelMixin, ConfigMixin):
    ...
    def forward(
        ...
        # print('DEBUG 0:', sample.shape, sample.max(), sample.min())
        # sample_ = (sample - sample.min()) / (sample.max() - sample.min())
        # torchvision.utils.save_image(sample_, './debug/debug0.png')
        # torchvision.utils.save_image(controlnet_cond, './debug/debug1.png')

...
class UNet2DConditionModel(ModelMixin, ConfigMixin, UNet2DConditionLoadersMixin):
    ...
    def __init__(
        ...
        if encoder_hid_dim_type == "text_proj": # text_proj, 4096
            self.encoder_hid_proj = nn.Linear(encoder_hid_dim, cross_attention_dim) # 4096 --> 2816
        ...
        if addition_embed_type == "text": # text
        ...
        for i, down_block_type in enumerate(down_block_types):
            ...
            down_block = get_down_block(
                ...
                attn_num_head_channels=attention_head_dim[i], # 64
                ...
                resnet_time_scale_shift=resnet_time_scale_shift, # "scale_shift"
                resnet_skip_time_act=resnet_skip_time_act, # False
                resnet_out_scale_factor=resnet_out_scale_factor, # 1.0
                cross_attention_norm=cross_attention_norm, # "group_norm"
            )

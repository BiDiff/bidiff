...
def render_views_from_rays(
    ...
    np.save('./rays.npy', rays.detach().cpu().numpy())
    ...
    # test
    # print("===== raw_density =====", output.raw_density.shape)
    # print("===== raw_signed_distance =====", output.raw_signed_distance.shape)
    # print("===== ts =====", output.ts.shape)
    # np.save('./raw_density.npy', output.raw_density.detach().cpu().numpy())
    # np.save('./raw_signed_distance.npy', output.raw_signed_distance.detach().cpu().numpy())
    # np.save('./ts.npy', output.ts.detach().cpu().numpy())
